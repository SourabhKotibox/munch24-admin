        ...
        {otpStep === "phone" ? (
          ...
          <form onSubmit={handleVerifyOtp} className="flex flex-col gap-3 sm:gap-3.5">
            <p className="text-white/70 text-[11px] font-semibold break-words">
              ...
              <button
                type="button"
                onClick={() => { setOtpStep("phone"); setOtp(""); setVerificationId(""); setError(""); }}
            ...
            <button
              ...
              className="text-center text-[11px] text-white/60 hover:text-white transition-colors py-1"
            >
              Didn't receive OTP? <span className="text-red-500 font-bold">Resend</span>
            </button>
          </form>
        )}
