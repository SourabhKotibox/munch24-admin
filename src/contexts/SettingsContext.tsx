...
const DEFAULT: AppSettings = {
  ...
  // Storage
   ...
   awsPathStyleEndpoint: false,
    ...
    doRegion: "sgp1",
    doBucket: "manch24",
    doCdnUrl: "https://manch24.sgp1.cdn.digitaloceanspaces.com",
    doPathStyle: false,
   bunnyStorageZone: "",
  bunnyAccessKey: "",
  bunnyCdnUrl: "",
...
function mapApiData(api: any): AppSettings {
  ...
  try {
    ...
    const updatedStorage = {
      ...
      doBucket: api.doBucket || existing.doBucket || DEFAULT.doBucket,
      doRegion: api.doRegion || existing.doRegion || DEFAULT.doRegion,
      doCdnUrl: api.doCdnUrl || existing.doCdnUrl || DEFAULT.doCdnUrl,
      doPathStyle: api.doPathStyle ?? existing.doPathStyle ?? DEFAULT.doPathStyle,
